    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                head_row: "flex",
                head_cell:
                    "text-zinc-500 rounded-md w-9 font-normal text-[0.8rem] uppercase tracking-tighter",
                ...
                day_outside:
                    "day-outside text-zinc-600 opacity-50 aria-selected:bg-white/5 aria-selected:text-zinc-500 aria-selected:opacity-30",
