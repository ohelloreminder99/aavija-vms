                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
                  <div className="md:col-span-2 relative">
                    ...
                    <Input
                      ...
                      className="pl-12 bg-black/40 border-white/5 text-white h-12 rounded-2xl placeholder:text-zinc-300 focus:border-primary/30"
                      value={searchTerm}
      ...
      <AlertDialog open={!!exportToConfirm} onOpenChange={(open) => !open && setExportToConfirm(null)}>
        <AlertDialogContent className="bg-black/90 border-white/10 backdrop-blur-2xl">
          ...
          <AlertDialogFooter className="gap-3 pt-6">
            ...
            <AlertDialogAction onClick={() => handleExecuteExport(exportToConfirm!)} disabled={isExporting !== null} className="bg-primary text-white font-black uppercase tracking-widest text-[10px] h-11 px-8 hover:bg-primary/90 shadow-[0_0_20px_rgba(16,185,129,0.2)]">
