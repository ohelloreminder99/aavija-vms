        ...
        <div className="space-y-4 text-center mt-8">
          ...
          <div className="text-left text-sm p-4 border rounded-lg bg-muted/50 space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-gray-300">
                <strong className="text-white">iOS (iPhone/iPad):</strong> Tap the "Share" icon <ArrowUpRightFromSquare className="inline-block h-4 w-4 text-gray-400" /> in Safari's toolbar, find and tap "Add to Home Screen", then toggle on for use as an app.
              </div>
            </div>
          </div>
        </div>
