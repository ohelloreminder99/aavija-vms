...
export function AuthForm({ mode }: AuthFormProps) {
  ...
  const referralBanner = mode === 'signup' && refCode ? (
    <div className="flex items-center gap-2 rounded-lg border border-green-200 bg-green-50 dark:bg-green-950/30 px-3 py-2 text-sm text-green-700 dark:text-green-400 mb-2">
