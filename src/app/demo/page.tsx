...
export default function DemoPage() {
    return (
        <div className="min-h-screen bg-[#010a05] text-white selection:bg-emerald-500/30">
            {/* Background Ambient Glow */}
            <div className="fixed inset-0 z-0 pointer-events-none">
                <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] bg-emerald-600/10 blur-[120px] rounded-full" />
                <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] bg-teal-900/10 blur-[120px] rounded-full" />
            </div>
                ...
                <section className="container max-w-7xl px-6 text-center">
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-6xl font-bold tracking-tighter mb-6">
                            ...
                            <span className="bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-teal-600">Access Management.</span>
                        </h1>
                    ...
                    >
                        <div className="absolute inset-0 flex items-center justify-center bg-black/60 group-hover:bg-black/40 transition-all cursor-pointer">
                            <div className="w-20 h-20 rounded-full bg-emerald-600 flex items-center justify-center shadow-[0_0_30px_rgba(16,185,129,0.6)] group-hover:scale-110 transition-transform">
                                <Play className="w-8 h-8 fill-white text-white ml-1" />
                            </div>
                        </div>
                        {/* Replace with actual video link if available later, for now a premium placeholder image */}
                        <div className="w-full h-full bg-gradient-to-br from-[#010a05] to-black flex items-center justify-center p-20 opacity-50">
                            <Shield className="w-40 h-40 text-emerald-500/10" />
                        </div>
                    </motion.div>
                    ...
                    <div className="mt-32 p-12 rounded-3xl border border-white/10 bg-gradient-to-br from-emerald-600/10 to-transparent">
                        ...
                        <Button size="lg" className="rounded-full px-10 h-14 bg-emerald-600 hover:bg-emerald-500 text-white font-bold border-emerald-400/50 shadow-[0_0_20px_rgba(16,185,129,0.3)]">
